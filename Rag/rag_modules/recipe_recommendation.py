        ...
        try:
            ...
            if image_url and not image_url.startswith("http"):
                if file_path:
                    ...
                    github_base = (
                        "https://media.githubusercontent.com/media/FutureUnreal/HowToCook/master/"
                    )
                    ...
                    if file.endswith(".md") and recipe_name in file:
                        ...
                        for line in lines:
                            ...
                            if "食材" in line or "原料" in line:
                                ...
                                line
                                and current_section == "steps"
                                and any(char.isdigit() for char in line[:3])
                            ):
                                steps.append(line)

                        return {"ingredients": ingredients, "steps": steps, "content": content}
